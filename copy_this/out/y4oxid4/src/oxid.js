/*
#########################################################################
#	$Id: 94d58ccdd3a161592bb25509003ff0f317340014 $
    ...
    mdVariants: {
        ...
        resetMdVariantSelection: function(e) {
            ...
            while (showId) {
                ...
                //BOF YAML4 VARIANTEN 
                showSelectedYmSelectorId = 'ym-selector_'+oxid.mdVariants.getMdSelectNameById(showId);
                showSelectedYmLabelId = 'ym-label_'+oxid.mdVariants.getMdSelectNameById(showId);
                //EOF YAML4 VARIANTEN
                oxid.mdVariants.showMdSelect(showSelectId);
                //BOF YAML4 VARIANTEN 
                oxid.mdVariants.showMdLabelSelect(showSelectedYmSelectorId);
                oxid.mdVariants.showMdLabelSelect(showSelectedYmLabelId);
                //BOF YAML4 VARIANTEN 
                ...
                if (mdVariantSelectIds[i]) {
                    for (var j=0; j < mdVariantSelectIds[i].length; j++) {
                        if (document.getElementById(mdVariantSelectIds[i][j])) {
                            ...
                            //BOF YAML4 VARIANTEN
                            document.getElementById('ym-label_'+mdVariantSelectIds[i][j]).style.display = 'none';
                            document.getElementById('ym-selector_'+mdVariantSelectIds[i][j]).style.display = 'none';
                            //EOF YAML4 VARIANTEN 
                        }
                    }
                }
