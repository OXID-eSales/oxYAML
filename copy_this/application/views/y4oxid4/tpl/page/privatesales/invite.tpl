[{*
#########################################################################
#	$Id: 31c647c88e8c7aabf1a1bd730ba17cc2b8b9add4 $
...
<strong id="recommendHeader" class="boxhead">[{$template_title}]</strong>
[{ if !$oView->getInviteSendStatus() }]
  ...
  <div class="box info" >
    ...
    [{ oxmultilang ident="INVITE_ABOUTDATAPROTECTION" }] <a id="infoProtection" href="[{ $oCont->getLink() }]" rel="nofollow">[{ $oCont->oxcontents__oxtitle->value }]</a><br>
    [{/oxifcontent}]
  </div>
[{else}]
  <div class="box info">
