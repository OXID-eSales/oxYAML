[{*
#########################################################################
#	$Id: fb3000eb482e8d460ba4cd4793781c7e07f328a9 $
    ...
    <form name="login" action="[{ $oViewConf->getSslSelfLink() }]" method="post" target="_top">
        ...
        <div class="loginBox">
            ...
            <div class="loginBoxBody">
                ...
                <input id="OrderConfirmAGBTop" type="checkbox" class="chk" name="ord_agb" value="1">

                [{oxifcontent ident="oxagb" object="oCont"}]
                    [{oxmultilang ident="ORDER_IAGREETOTERMS1" }] <a id="OrderOpenAGBTop" rel="nofollow" href="[{ $oCont->getLink() }]" onclick="window.open('[{ $oCont->getLink()|oxaddparams:"plain=1"}]', 'agb_popup', 'resizable=yes,status=no,scrollbars=yes,menubar=no,width=620,height=400');return false;">[{ oxmultilang ident="ORDER_IAGREETOTERMS2" }]</a> [{ oxmultilang ident="ORDER_IAGREETOTERMS3" }],&nbsp;
                [{/oxifcontent}]
                [{oxifcontent ident="oxrightofwithdrawal" object="oCont"}]
                    [{ oxmultilang ident="ORDER_IAGREETORIGHTOFWITHDRAWAL1" }] <a id="OrderOpenWithdrawalTop" rel="nofollow" href="[{ $oCont->getLink() }]" onclick="window.open('[{ $oCont->getLink()|oxaddparams:"plain=1"}]', 'rightofwithdrawal_popup', 'resizable=yes,status=no,scrollbars=yes,menubar=no,width=620,height=400');return false;">[{ $oCont->oxcontents__oxtitle->value }]</a> [{ oxmultilang ident="ORDER_IAGREETORIGHTOFWITHDRAWAL3" }]
                [{/oxifcontent}]
            ...
            <div class="loginBoxBody">
                ...
                <input id="LoginEmail" type="text" id="userLoginName" name="lgn_usr" value="" size="49" class="txt"><br>
                ...
                <input id="LoginKeepLoggedIn" class="chbox" type="checkbox" name="lgn_cook" value="1"><span class="chboxDesc">[{ oxmultilang ident="INC_CMP_LOGIN_KEEPLOGGEDIN" }]</span>
                [{/if}]

                <div class="loginBtn">
                    <input id="Login" type="submit" class="btn" name="send" value="[{ oxmultilang ident="INC_CMP_LOGIN_LOGIN" }]"><br>
                </div>
            </div>
            ...
            <div class="loginBoxFooter">
                ...
                [{oxifcontent ident="oxagb" object="oCont"}]
                  <br /><a id="LoginTerms" rel="nofollow" class="link" href="[{ $oCont->getLink()|oxaddparams:"plain=1" }]" onclick="window.open('[{ $oCont->getLink()|oxaddparams:"plain=1"}]', 'terms_popup', 'resizable=yes,status=no,scrollbars=yes,menubar=no,width=620,height=400');return false;">[{ $oCont->oxcontents__oxtitle->value }]</a>
                [{/oxifcontent}]
                [{oxifcontent ident="oximpressum" object="oCont"}]
                  <br /><a id="LoginAboutUs" rel="nofollow" class="link" href="[{ $oCont->getLink()|oxaddparams:"plain=1" }]" onclick="window.open('[{ $oCont->getLink()|oxaddparams:"plain=1"}]', 'aboutus_popup', 'resizable=yes,status=no,scrollbars=yes,menubar=no,width=620,height=400');return false;">[{ $oCont->oxcontents__oxtitle->value }]</a>
                [{/oxifcontent}]
                [{oxifcontent ident="oxrightofwithdrawal" object="oCont"}]
                  <br /><a id="LoginRightOfWithdrawal" rel="nofollow" class="link" href="[{ $oCont->getLink()|oxaddparams:"plain=1" }]" onclick="window.open('[{ $oCont->getLink()|oxaddparams:"plain=1"}]', 'rightofwithdrawal_popup', 'resizable=yes,status=no,scrollbars=yes,menubar=no,width=620,height=400');return false;">[{ $oCont->oxcontents__oxtitle->value }]</a>
                [{/oxifcontent}]
