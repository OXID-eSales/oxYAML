[{*
#########################################################################
#	$Id: 0ddfd969dfa90b1a30cf2750f8f24ec49c7d95e2 $
...
[{/if}]
  ...
  <strong id="productComparisonHeader" class="boxhead">[{$template_title}]</strong>
        ...
        <form action="[{ $oViewConf->getSelfActionLink() }]" method="post">
          <div>
              ...
              <div class="fromcompare" >
                 <input id="remove_cmp_[{ $product->oxarticles__oxid->value }]" type="submit" value="[{ oxmultilang ident="COMPARE_REMOVE" }]" name="send">
              </div>
              [{/oxhasrights}]
          </div>
        </form>
...
<div class="bar prevnext">
    <form action="[{ $oViewConf->getSelfActionLink() }]" name="order" method="post">
      <div>
          ...
          <div class="right">
              <input id="BackToShop" type="submit" value="[{ oxmultilang ident="COMPARE_BACKTOSHOP" }]">
          </div>
      </div>
    </form>
</div>
