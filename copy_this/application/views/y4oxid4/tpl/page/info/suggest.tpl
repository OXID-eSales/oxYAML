[{*
#########################################################################
#	$Id: 86c8158f2680d516ca962aa5d88a7075699f80f3 $
...
<h1 id="recommendHeader" class="boxhead">[{$template_title}]</h1>
...
[{assign var="editval" value=$oView->getSuggestData()}]
  <div class="ym-form" >
    ...
    [{ oxmultilang ident="SUGGEST_ABOUTDATAPROTECTION" }] <a id="infoProtection" href="[{ $oCont->getLink() }]" rel="nofollow">[{ $oCont->oxcontents__oxtitle->value }]</a><br>
    [{/oxifcontent}]
  </div>
