[{*
#########################################################################
#   $Id: 4f8d582218542bce3fec3cc2b58ee184c1014c93 $
#   Project:    YAML4 OXID eSales 4 Template 4.7.x
#   ProjectId:  oxYaml 
...
#########################################################################
*}]
[{assign var="template_title" value="THANK_YOU"|oxmultilangassign}]
[{include file="layout/header.tpl" title=$template_title location=$template_title}]
    ...
    [{block name="checkout_thankyou_main"}]
        ...
        <div id="thankyouPage">
            <h3 class="blockHead">[{ oxmultilang ident="THANK_YOU" }]</h3><br><br>

            [{block name="checkout_thankyou_info"}]
                [{ oxmultilang ident="THANK_YOU_FOR_ORDER" }] <strong>[{ $oxcmp_shop->oxshops__oxname->value }]</strong>. <br><br>
                [{ oxmultilang ident="REGISTERED_YOUR_ORDER" args=$order->oxorder__oxordernr->value}] <br><br>
                [{if !$oView->getMailError() }]
                    [{ oxmultilang ident="MESSAGE_YOU_RECEIVED_ORDER_CONFIRM" }]<br><br>
                [{else}]<br>
                    [{ oxmultilang ident="MESSAGE_CONFIRMATION_NOT_SUCCEED" }]<br><br>
                [{/if}]
                <br>
