[{* basket contents *}]
[{oxscript include="javascript/widgets/oxbasketchecks.js" priority=10 }]
[{oxscript add="$('#checkAll, #basketRemoveAll').oxBasketChecks();"}]
[{assign var="currency" value=$oView->getActCurrency()}]
<form name="basket[{$basketindex}]" action="[{$oViewConf->getSelfActionLink()}]" method="post" class="ym-form">
            ...
            [{block name="checkout_basketcontents_basketitem"}]
                ...
                <tr id="cartItem_[{$smarty.foreach.basketContents.iteration}]">
                        ...
                        <td>
                            ...
                            [{else}]
                                [{if $basketproduct->oxarticles__oxisconfigurable->value}]
                                    ...
                                    [{else}]
                                         <div class="ym-fbox-text">
                                                <label >[{ oxmultilang ident="LABEL" suffix="COLON" }] <input class="textbox persParam" type="text" name="aproducts[[{ $basketindex }]][persparam][details]" value=""></div>
                                    [{/if}]
                                [{/if}]
                            [{/if}]
                    ...
                    [{block name="checkout_basketcontents_basketitem_quantity"}]
                        ...
                        <td class="quantity ym-fbox-text">
                            [{if $editable }]
    ...
    <div class="ym-grid clear">
        ...
        [{block name="checkout_basketcontents_basketfunctions"}]
            [{if $editable }]
                <div id="basketFn" class="basketFunctions ym-g50 ym-gl">
        ...
        [{block name="checkout_basketcontents_summary"}]
            <div id="basketSummary" class="summary[{if $oViewConf->getActiveClassName() == 'order' }] orderSummary[{/if}] ym-g50 ym-gr">
                [{*  basket summary  *}]
                <table>
