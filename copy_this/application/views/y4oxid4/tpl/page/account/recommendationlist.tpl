[{*
#########################################################################
#	$Id: 698f074700d0bc33476b4bbe830fe24b207dde7b $
...
<div class="ym-form">
<h6 id="recomListHeader1" class="boxhead">[{if $actvrecommlist}][{$actvrecommlist->oxrecommlists__oxtitle->value}][{else}][{ oxmultilang ident="ACCOUNT_RECOMM_NEWLIST" }][{/if}]</h6>
