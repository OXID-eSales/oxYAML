[{*
#########################################################################
#	$Id: c93fed285d34dcc87e2e0329ee7b8b6d869a4e84 $
...
[{include file="layout/header.tpl" title=$template_title location=$template_title}]
  ...
  [{if !$oView->floodProtection() || !$oxcmp_user->oxuser__oxpassword->value}]
    <strong id="guestbookWriteHeader" class="boxhead">[{ oxmultilang ident="GUESTBOOK_WRITEENTRY" }]</strong>
    <div class="box info">
  ...
  <strong id="guestbookHeader" class="boxhead">[{ oxmultilang ident="GUESTBOOK_GUESTBOOK" }]</strong>
  <div class="box info">
    [{ if $oView->getEntries() }]
