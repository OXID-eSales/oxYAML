[{*
#########################################################################
#	$Id: abac81e32f03059b53db7982b875378968ef5f72 $
...
[{if $oViewConf->getShowFbConnect()}]
        ...
        <strong class="h2"><a id="RightSideNewsLetterHeader" rel="nofollow" href="[{ oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=account"}]">[{ oxmultilang ident="INC_RIGHTITEM_FBCONNECT" }]</a></strong>
        <div class="box">
